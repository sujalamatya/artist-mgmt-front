...
//   try {
//     const response = await axiosInstance.post(
//       `${ARTIST_API_BASE_URL}/artists/${songData.artist_id}/songs/`, //------------------DONE
//       songData
//     );
//     return response.data;
//   } catch (error: any) {
...
//   try {
//     const response = await axiosInstance.get(`${API_BASE_URL}/users/`); //------------------------DONE
//     return response.data;
//   } catch (error: any) {
//     throw error.response ? error.response.data : error.message;
//   }
...
//   const response = await axiosInstance.delete(`${API_BASE_URL}/users/${id}/`); //_----------------------DONE
